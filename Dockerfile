...
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name visualizer visualizer
...
# Create a non-root user and pre-create directories with correct ownership
RUN groupadd --system --gid 1000 rails && \
    useradd rails --uid 1000 --gid 1000 --create-home --shell /bin/bash && \
    mkdir -p /rails/node_modules /rails/tmp /rails/log && \
